...
| CK/MI 代码线索 | `nexus` | MI ROI360 报表字段、聚合口径、表路由 |
| PGP CK 接入线索 | `pgp-platform` | ClickHouse 配置、只读 client、验真文档 |
...
| Obsidian 候选知识 | `local_obsidian_vault/8方块`（本机，不入库） | 投放术语、S2S、素材、campaign、AppLovin / partner 语义；先进入草稿区审核 |
